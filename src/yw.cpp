...
NC_STACK_ypamissile * NC_STACK_ypaworld::ypaworld_func147(ypaworld_arg146 *arg)
{
    ...
    const bool supportsProjectileSpiral = wproto.SupportsProjectileSpiral();
    wobj->_spiral_speed = supportsProjectileSpiral ? wproto.spiral_speed : 0.0f;
    wobj->_spiral_radius = supportsProjectileSpiral ? wproto.spiral_radius : 0.0f;
    wobj->_spiral_forward = supportsProjectileSpiral ? wproto.spiral_forward : 0.0f;
    wobj->ResetProjectileSpiralVisualFreeze();
