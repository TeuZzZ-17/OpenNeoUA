...
public:
    ...
    // One entry per World::INPUT_BIND hotkey slot: this table must stay at least
    // as large as World::INPUT_BIND_MAX or a newer binding cannot be persisted.
    std::array<int16_t, 55>       _hotKeys;
